...
-- SELECT 
-- SUM(CASE WHEN DTYPE IS NOT NULL THEN 1 ELSE 0 END) As number_of_all_persons
-- FROM person;


-- SELECT 'car' AS table_name, COUNT(*) AS ilosc_wierszy
-- FROM car
-- UNION ALL
-- SELECT 'motorcycle' AS table_name, COUNT(*) AS ilosc_wierszy
-- FROM motorcycle
-- UNION ALL
-- SELECT 'bike' AS table_name, COUNT(*) AS ilosc_wierszy
-- FROM bike
-- UNION ALL
-- SELECT 'scooter' AS table_name, COUNT(*) AS ilosc_wierszy
-- FROM scooter;
